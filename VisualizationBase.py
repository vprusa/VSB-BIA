...
class VisualizationBase(object):
    ...
    def __init__(s, nxgraphType=None, nxgraphOptions=None, graphData=None, frameTimeout=1):
    ...
    def update(s, edges=None):
        ...
        nx.draw_networkx_labels(s.G, pos=s.pos, labels=dict(zip(forestNodes, forestNodes)), font_color="white",
                                ax=s.ax)
